...
class Job(models.Model):
    ...
    ('Coach', 'Coach'),
    ('Community Outreach Worker','Community Outreach Worker'),
    ...
    ('Data Center Support Specialist','Data Center Support Specialist'),
    ...
    ('Painter', 'Painter'),
    ('Paramedic', 'Paramedic'),
    ('Paste Control Technician','Paste Control Technician'),
    ...
    ('Under Writer','Under Writer'),
    ('Upholsterer','Upholsterer'),
    ('Urban Planner','Urban Planner'),
    ('Usability Specialist','Usability Specialist'),
    ('UX Designer','UX Designer'),
    ('Veterinarian Technician', 'Veterinarian Technician'),
    ...
    ('Warehouse Woker','Warehouse Worker'),
    ...
    ('Youth Counselor','Youth Counselor'),
    ('Youth Program Coordinator','Youth Program Coordinator'),
    ('ZooKeeper','ZooKeeper'),
    ('Zoologist', 'Zoologist'),
    ]

    job_title = models.CharField(max_length=50, choices=JOB_TITLE_CHOICES, default='Accountant')
    ...
    ('Copywriter', 'Copywriter'),
    ('Crisis Management Specialist', 'Crisis Management Specialist'),
    ...
    ('Part-Time', 'Part-Time'),
    ('Pharmacist', 'Pharmacist'),
    ('Philanthropy Manager', 'Philanthropy Manager'),
    ('Physical Therapist', 'Physical Therapist'),
    ...
    experience = models.CharField(max_length=50, choices=EXPERIENCE_TYPE_CHOICES, default='Fresher')
...
class Company(models.Model):
    ...
    SECTOR_CHOICES = [
        ...
        ('Services to buildings', 'Services to buildings'),
        ('Accommodation', 'Accommodation'),
        ('Advertising', 'Advertising'),
        ('Agriculture', 'Agriculture'),
        ('Air transport', 'Air transport'),
        ('Architectural & related', 'Architectural & related'),
        ...
        ('Coal, oil & gas; Mining & related', 'Coal, oil & gas; Mining & related'),
        ('Coke & refining (chemicals etc.)', 'Coke & refining (chemicals etc.)'),
        ('Computer programming', 'Computer programming'),
        ('Computers', 'Computers'),
        ('Construction', 'Construction'),
        ('Residential care', 'Residential care'),
        ('Specialised construction', 'Specialised construction'),
        ('Wearing apparel; Leather, etc', 'Wearing apparel; Leather, etc'),
        ('Coal, oil & gas; Mining & related', 'Coal, oil & gas; Mining & related'),
        ('Head offices', 'Head offices'),
        ('Membership organisations', 'Membership organisations'),
        ('Office administration', 'Office administration'),
        ('Other non-metallic', 'Other non-metallic'),
        ('Other personal service', 'Other personal service'),
        ...
        ('Sale of motor vehicles', 'Sale of motor vehicles'),
        ('Insurance & pensions', 'Insurance & pensions'),
        ('Other personal service', 'Other personal service'),
        ('Other professional', 'Other professional'),
        ('Paper', 'Paper'),
        ('Pharmaceuticals', 'Pharmaceuticals'),
        ('Postal', 'Postal'),
        ('Printing & recording', 'Printing & recording'),
        ('Public service & defence', 'Public service & defence'),
        ...
        ('Rental & leasing', 'Rental & leasing'),
        ('Repair & installation', 'Repair & installation'),
        ('Repair of goods', 'Repair of goods'),
        ('Residential care', 'Residential care'),
        ('Retail trade', 'Retail trade'),
        ('Rubber & plastic', 'Rubber & plastic'),
        ('Scientific research', 'Scientific research'),
        ...
        ('Electricity, gas, etc', 'Electricity, gas, etc'),
    ...
    sector_type = models.CharField(max_length=50, choices=SECTOR_CHOICES, default='Basic metals')
...
class CandidateStatus_not_selected(models.Model):
    STATUS_CHOICES = [
        ('not_selected', 'Not Selected'),
    ]
    candidate_name = models.CharField(max_length=255)
